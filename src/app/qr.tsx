...
import { View, ScrollView, Pressable, Share, Linking } from 'react-native'
    ...
    return (
      <LinearGradient colors={['#2a0a0a', '#1a0a0a', '#0a0a0a']} className="flex-1">
        <ScrollView className="flex-1 px-4 pt-12">
          ...
          <PS2PText className="text-[#ff6f61] text-2xl mb-2 mt-8">
            🚑 EMERGENCY
          </PS2PText>
          <PS2PText className="text-[#b39eb5] text-[8px] mb-8">
            VERIFIED ON SOLANA
          </PS2PText>
          ...
          <View className="border-4 border-[#ff6f61] p-4 mb-4" style={{ shadowColor: '#ff6f61', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.5, shadowRadius: 15 }}>
            ...
            <PS2PText className="text-[#ffd9b3] text-xl">
          ...
          <View className="border-2 border-[#00ff9d] p-4 mb-4">
            ...
            <PS2PText className="text-[#00ff9d] text-3xl">
          ...
          <View className="border-2 border-[#8a2be2] p-4 mb-4">
            <PS2PText className="text-[#b39eb5] text-[10px] mb-3">
              CONDITIONS
            </PS2PText>
            {medicalInfo.conditions.length > 0 ? (
              medicalInfo.conditions.map((condition, index) => (
                <View key={index} className="flex-row items-center mb-2">
                  <PS2PText className="text-[#ffd9b3] text-xs flex-1">
                    • {condition.name}
                  </PS2PText>
              ...
              <PS2PText className="text-[#b39eb5] text-xs">
                NONE RECORDED
              </PS2PText>
            )}
          </View>
          ...
          <View className="border-2 border-[#ff6f61] p-4 mb-8">
            ...
            {medicalInfo.emergencyContacts.map((contact, index) => (
              ...
              >
                ...
                <PS2PText className="text-[#b39eb5] text-[6px] mt-1">
                  {contact.relationship}
                </PS2PText>
                <PS2PText className="text-[#ff6f61] text-xs mt-2">
                  {contact.phone}
                </PS2PText>
              </Pressable>
            ))}
          ...
          <PS2PText className="text-[#4a2c5a] text-[6px] text-center mb-8">
  ...
  return (
    <LinearGradient colors={['#0a0a1f', '#1a0f2e', '#000000']} className="flex-1">
      ...
      <ScrollView className="flex-1 px-4 pt-4">
        ...
        <PS2PText className="text-[#b39eb5] text-[8px] mb-6">
        ...
        {isLoading ? (
          ...
          <View className="border-2 border-[#ff6f61] p-6 items-center">
            <PS2PText className="text-4xl mb-3">⚠️</PS2PText>
            <PS2PText className="text-[#ff6f61] text-xs mb-2 text-center">
              NO MEDICAL DATA FOUND
            </PS2PText>
            <PS2PText className="text-[#b39eb5] text-[8px] text-center mb-4">
          ...
          <>
            <View className="items-center mb-6">
              ...
              <Pressable 
                ...
                style={{ shadowColor: '#ff6f61', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.5, shadowRadius: 10 }}
              >
                <PS2PText className="text-[#ff6f61] text-xs">
                  SAVE QR CODE
                </PS2PText>
              </Pressable>
            </View>
            ...
            <View className="border-2 border-[#8a2be2] p-4 mb-6">
              <PS2PText className="text-[#ffd9b3] text-xs mb-3">
                📱 SET AS LOCK SCREEN
              </PS2PText>
              <View>
                <View className="flex-row mb-2">
                  <PS2PText className="text-[#ff6f61] text-[8px] mr-2">1.</PS2PText>
                  <PS2PText className="text-[#b39eb5] text-[8px] flex-1">
                    TAKE SCREENSHOT
                  </PS2PText>
                </View>
                <View className="flex-row mb-2">
                  <PS2PText className="text-[#ff6f61] text-[8px] mr-2">2.</PS2PText>
                  <PS2PText className="text-[#b39eb5] text-[8px] flex-1">
                    SETTINGS → WALLPAPER
                  </PS2PText>
                </View>
                <View className="flex-row">
                  <PS2PText className="text-[#ff6f61] text-[8px] mr-2">3.</PS2PText>
                  <PS2PText className="text-[#b39eb5] text-[8px] flex-1">
            ...
            >
              <PS2PText className="text-[#ff6f61] text-xs text-center">
                🚑 EMERGENCY MODE
              </PS2PText>
            </Pressable>
            ...
            <View className="border-2 border-[#00ff9d] p-4 mb-8">
              ...
              <PS2PText className="text-[#b39eb5] text-[8px] mt-1">
