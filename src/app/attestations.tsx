  ...
  if (!account) {
    return (
      <LinearGradient colors={['#0a0a1f', '#1a0f2e', '#000000']} className="flex-1 items-center justify-center">
        <PS2PText className="text-[#ffd9b3]">CONNECT WALLET</PS2PText>
      </LinearGradient>
    )
  }
    ...
    <LinearGradient colors={['#0a0a1f', '#1a0f2e', '#000000']} className="flex-1">
      ...
      <View className="flex-1 px-4 pt-4">
        ...
        <View className="flex-row mb-4">
          ...
          >
            <PS2PText className={`text-center text-xs ${activeTab === 'received' ? 'text-[#ff6f61]' : 'text-[#b39eb5]'}`}>
              RECEIVED
            </PS2PText>
          </Pressable>
          <Pressable
          ...
          >
            <PS2PText className={`text-center text-xs ${activeTab === 'issued' ? 'text-[#ff6f61]' : 'text-[#b39eb5]'}`}>
              ISSUED
            </PS2PText>
          </Pressable>
        </View>
        ...
        {activeTab === 'issued' && (
          ...
          >
            <PS2PText className="text-[#00ff9d] text-xs mr-2">+ ISSUE NEW</PS2PText>
          </Pressable>
        )}

        {showIssueForm && (
          <View className="border-2 border-[#6a0dad] p-4 mb-4">
            <PS2PText className="text-[#ffd9b3] text-xs mb-3">ISSUE ATTESTATION</PS2PText>
            <PS2PTextInput
            ...
            <View className="flex-row mb-3">
              ...
              >
                <PS2PText className={`text-center text-[8px] ${issueForm.type === 'employment' ? 'text-[#ff6f61]' : 'text-[#b39eb5]'}`}>EMPLOYMENT</PS2PText>
              </Pressable>
              <Pressable
              ...
              >
                <PS2PText className={`text-center text-[8px] ${issueForm.type === 'rental' ? 'text-[#ff6f61]' : 'text-[#b39eb5]'}`}>RENTAL</PS2PText>
              </Pressable>
              <Pressable
              ...
              >
                <PS2PText className={`text-center text-[8px] ${issueForm.type === 'income' ? 'text-[#ff6f61]' : 'text-[#b39eb5]'}`}>INCOME</PS2PText>
              </Pressable>
            </View>
            ...
            <View className="flex-row">
              ...
              >
                <PS2PText className="text-[#00ff9d] text-xs text-center">ISSUE</PS2PText>
              </Pressable>
            </View>
          </View>
        )}
        ...
        <ScrollView className="flex-1">
          {activeTab === 'received' && attestations.length === 0 && (
            <View className="border-2 border-[#6a0dad] p-6 items-center">
              <PS2PText className="text-[#b39eb5] text-xs text-center">
                NO ATTESTATIONS YET
              </PS2PText>
              <PS2PText className="text-[#4a2c5a] text-[8px] text-center mt-2">
          ...
          {activeTab === 'received' && attestations.map((att) => (
            ...
            >
              <View className="flex-row justify-between mb-2">
                <PS2PText className="text-[#ffd9b3] text-[8px]">
              ...
              <PS2PText className="text-[#b39eb5] text-[10px] mb-2">
                {att.predicate}
              </PS2PText>
              <PS2PText className="text-[#4a2c5a] text-[6px]">
          ...
          {activeTab === 'issued' && pendingRequests.map((att) => (
            <View key={att.id} className="border-2 border-[#8a2be2] p-4 mb-3">
              ...
              <PS2PText className="text-[#b39eb5] text-[8px] mb-1">
